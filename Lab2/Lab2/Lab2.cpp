...
BEGIN_MESSAGE_MAP(CLab2App, CWinAppEx)
...
// CLab2App customization load/save methods

void CLab2App::PreLoadState()
{
	BOOL bNameValid;
	CString strName;
...
void CLab2App::LoadCustomState()
{
}

void CLab2App::SaveCustomState()
{
}
